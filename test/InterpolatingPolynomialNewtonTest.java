...
class InterpolatingPolynomialNewtonTest {

    @Test
    void testDefaultConstructor() {
        InterpolatingPolynomialNewton poly = new InterpolatingPolynomialNewton();
    ...
    void testConstructorWithPoints() {
        ...
        InterpolatingPolynomialNewton poly = new InterpolatingPolynomialNewton(points);
    ...
    void testPolynomialCalculation() {
        ...
        InterpolatingPolynomialNewton poly = new InterpolatingPolynomialNewton(points);
        System.out.println(poly.calc(1.0));
        System.out.println(poly.calc(2.0));
        System.out.println(poly.calc(3.0));
    ...
    void testIllegalArgumentException() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> new InterpolatingPolynomialNewton(invalidPoints));
